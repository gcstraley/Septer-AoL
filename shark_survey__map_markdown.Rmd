...
#importing data
```{r}
AoL_r<-read.csv("~/Desktop/AoL_map/AoL_map_02102026.csv", header = TRUE)
...
annotate(
  ...
  # 🔑 Water background MUST come AFTER theme_minimal()
  theme(
